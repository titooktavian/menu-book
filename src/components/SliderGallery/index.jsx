...
const SliderGallery = ({ productList }) => {
    // const menuItems = [
        ...
        <div className="slider-container w-full md:w-3/5">
            <Slider {...settings}>
                {productList.map(item => (
                    <div key={item.id_product} className="flex flex-col gap-2 items-center mb-10">
                        <img src={item.product_image} className="w-4/5 rounded-lg aspect-square" />
